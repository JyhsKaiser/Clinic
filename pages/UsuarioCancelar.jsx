...
export default function UsuarioCancelar(){
        ...
        <div>            
            <form className="center-Cita" onSubmit={handleSubmit} >
                <div className='center-form'>
                    <div>
                    <h1 className="title">Cancelar cita</h1>
                    ...
                    <div className='calendar'>
                        <h3 className="class-h3">Por favor seleccion en el calendario la cita a cancelar:</h3>
                        <Calendar/>  
                        <button className="class-button" type="submit" >Cancelar</button>
                    </div>
